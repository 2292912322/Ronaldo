...
<template>
  <div class="pc-home">
    ...
    <div class="pc-home__list pc-list">
      <scroller :on-infinite="infinite" :noDataText="noDataText">
        <div
          class="pc-list__item"
        ...
        >
          ...
          <div>
            ...
            <!-- <span>{{item.Size}}</span> -->
            <span style="color:red">￥{{item.OfferPrice |pcNumFormat}} {{item.Size}}</span>
          ...
          <div v-if="item.SupplierId" @click.stop class="pc-list__item--input">
            ...
            <div>
              ...
              <input pattern="\d*" v-model.number="item.num" @change="inputNum(index)">
              <!-- <span>{{item.num}}</span> -->
        ...
        <span
          v-if="list.length===0"
          style="min-height: 80vh;display: flex;align-items: center;justify-content: center;font-size: 24px;"
        >暂无数据</span>
      </scroller>
    </div>
    <!-- <x-input placeholder="输入验证码"></x-input> -->
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    // CashierCode: "103"
    // CashierName: "主管"
    // EnterpriseCode: "ET20180786220"
    // Id: "1a54a02b-231f-417e-86df-6af33be1ecc1"
    // OpenId: "oIeE50xglbH56WDnhaj3xrd9VNtM"
    // StoreCode: "10004"
    // StoreId: "f09633b1-d2b2-4aa7-a6d0-84c28391da45"
    // StoreName: "廉江博士轩店"
    async getHot() {
      let that = this;
