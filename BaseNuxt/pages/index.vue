...
<template>
  <div class="container">
    <!-- 页面容器 -->
    <nuxt-child/>
    <nav class="wc-navbar" :class="{'wc-navbar--show':navbarShow}">
      <button class="wc-navbar__nav" @click="onNav('/home')" v-xy-moving-btn>
        <!-- <i class="icons-common-nav-bar-car-outer">
          <div class="icons-common icons-common-nav-bar-car-inner"></div>
        </i>-->
        <span>用车</span>
      </button>
      <button class="wc-navbar__nav" @click="onNav('/my/order')" v-xy-moving-btn>
        <!-- <i class="icons-common-nav-bar-order-outer">
          <div class="icons-common icons-common-nav-bar-order-inner"></div>
        </i>-->
        <span>订单</span>
      </button>
      <button class="wc-navbar__nav" @click="onNav('/my')" v-xy-moving-btn>
