  ...
  <div class="wc-order-detail">
        ...
        <div class="wc-box__ct">
          <div class="wc-box__title wc-box__title--f30 wc-order-detail__top">
            <i class="lazy-load wc-order-detail__top__face">
              <img v-if="detail.carModelSmallUrl"
                   v-lazy="detail.carModelSmallUrl"
                   class="lazy-contain">
            </i>
    ...
    <div class="wc-card">
      <section class="wc-order-detail__time">
        <label>{{detail.orderMny | wcNumFormat}}</label>
      ...
      <section class="wc-order-detail__money"
        ...
        <div v-for="item in detail.costList"><span>{{item.name}}</span><span>{{item.value | wcNumFormat}}元</span></div>
      </section>
    </div>
