  ...
  <div>
    ...
    <div v-if="isRecharge">
      <div class="wc-card wc-paySuccess-card">
        ...
        <span>充值成功</span>
        <span>充值金额{{moneyArr[isActive]}}元整</span>
      </div>
    </div>
  </div>
</template>
