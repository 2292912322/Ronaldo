export default [
  ...
  { 
    ...
    // couponType	优惠券类型	是	String	01现金券 02折扣券 03通乘券
    // couponMoney	现金优惠券金额	是	int	
    // conditionMoney	现金优惠卷满减条件	是	int	
    // discount	折扣优惠券折扣	是	int	
    // maxDiscountMoney	折扣优惠券最大折扣金额	是	int	
    // minPayMoney	通乘券最小支付金额	是	int	
    // freeTime	通乘券免费约车时间	是	int	
    // couponStartTime	有效时间开始	是	long	
    // couponEndTime	有效时间结束	是	long	
    // couponId	优惠券ID	是	int	
    // memberId	客户ID	是	int	
    // couponCode	优惠券编码	是	String	
    // couponStatus	优惠券状态	是	String	0未使用 1已经使用
    // couponReceiveTime	优惠券获取时间	是	long	
    // couponUseTime	优惠卷使用时间	是	long	
    // describe	优惠券描述	是	String	
    name: 'customer_coupon',
    desc: '查询用户优惠券列表',
    path: '/v206/customer/warmcar_query_customer_coupon_service',
    mockPath: '',
    params: {
      page:1,//	页码	是	int	默认第一页	1
      size:10,//	一页记录数	是	int		10
      available:''//	01可用优惠券，02已使用或过期优惠券	是	String		
          },
    cache: false
  },
  {
    ...
    name: 'order_coupon',
    desc: '查询订单可用优惠券',
    path: '/v206/control/warmcar_query_order_coupon_service',
    mockPath: '',
    params: {
      page:1,//	页码	是	int	默认第一页	1
      size:10,//	一页记录数	是	int		10
      orderId:'',//	订单Id	是	int		10
    },
    cache: false
  },
  {
    // labels	标签	是	List		<>
    // titleHead1	标题头1	是	String		意见反馈，。。。。
    // titleHead2	标题头2	是	String		反馈说明
        //labels
        // sort	排序	是	int		1、2
        // title	标题	是	String		开心、不开心
        // labelTitle	标签标题	是	String		简直完美、意见反馈
        // contents	标签内容	是	List		<>
          //content	标签内容	是	String		车需清洁等
    name: 'return_car_face_back_label',
    desc: '查询用完车评价标签',
    path: '/v206/order/warmcar_query_return_car_face_back_label_service',
    mockPath: '',
    params: {},
    cache: false
  },
  ...
  // },
  {
    ...
    name: 'deposit_quota',
    desc: '查询保证金额度',
    path: '/v206/customer/warmcar_query_deposit_quota_service',
    mockPath: '',
    params: {
      cityCode:''//	城市编码	是	String	城市编码
    },
    cache: false
  },
]